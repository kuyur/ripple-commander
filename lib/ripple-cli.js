...
/**
 * First, get required fields of destination by url of bridge. For example,
...
RippleCLI.prototype.showHelp = function() {
  ...
  console.log('  send <destination> <currency+issuer> <amount> [ --source-tag=<source_tag> ] [ --destination-tag=<destination_tag> ] [ --invoice-id=<invoice_id> ] [ --choose-path ]');
