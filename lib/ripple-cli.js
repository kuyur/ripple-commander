...
RippleCLI.prototype.handleReadline_ = function(line) {
  ...
  } else if (params[0] === 'get-order-book') {
...
RippleCLI.prototype.getOrderBook = function(currency1, currency2) {
  // TODO
};
...
RippleCLI.prototype.showHelp = function() {
  ...
  console.log('  get-order-book <currency1+issuer1> <currency2+issuer2>')
