...
exports.API = {
  ...
  BRIDGE: {
    method: 'GET',
    url: 'https://{domain}/bridge?type=federation&destination={destination}&domain={domain}'
  },
  QUOTE_BRIDGE_PAYMENT: {
    method: 'GET',
    url: 'https://{domain}/bridge?type=quote&destination={destination}&domain={domain}&amount={amount}&source={address}'
  }
};
